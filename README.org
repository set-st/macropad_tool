...
Normal macropad orientation is when buttons are on the left
...
** GUI Mode
A modern graphical interface is available for easier configuration. This GUI was developed as a showcase of *Rust* and *Gemini CLI* capabilities.

[[gui_screen.png]]

To launch the GUI:
#+begin_example
macropad-tool show-gui
#+end_example

** Quick Start (Cross-platform)
For convenience, use the provided launch scripts to automatically check dependencies and start the editor:

- *MacOS:* Run =./run_macos.sh= (don't forget =chmod +x run_macos.sh=)
- *Linux:* Run =./run_linux.sh= (automatically installs libusb-dev)
- *Windows:* Double-click =run_windows.bat=

*Note:* This build has been primarily tested on *macOS*. While launch scripts for other systems are provided, they require further community testing.

*** Disclaimer
*Note:* This GUI extension is provided for educational and demonstrational purposes. The author assumes no responsibility for any damage, data loss, or bricked devices resulting from the use of this software. Use at your own risk! :)
